...
**** 思路整理
***** 题目
Implement 3D reconstruction by using Structure from Mothon (SFM)
***** 工具：
openCV python
***** paper:      
...
doi: 10.1109/ICCV.2013.403S. Agarwal, N. Snavely, I. Simon, S. Seitz, and R. Szeliski. Building rome in a day. In Proc. ICCV, 2009.
***** approach： 
****** SIFT 
